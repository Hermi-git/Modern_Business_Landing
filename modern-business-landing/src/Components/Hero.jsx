...
const Hero = () => {
  return (
    <section id='home' className='container mx-auto flex flex-col md:flex-row justify-between item-center pt-44 pb-6 px-4 sm:px-6 lg:ps-8'>
        {/* left column */}
      ...
      font-bold leading-tight'>We boost the growth for <span className='text-blue-600 relative inline-block'>startup to Fortune 500 <span className='absolute bottom-0 left-0 w-full h-0.5 bg-blue-200/60'></span></span> Companies 
      ...
      <div className='flex gap-3 max-w-md'>
        ...
        <button className='bg-blue-600 text-white px-8 py-4 rounded-xl hover:bg-blue-700 cursor-pointer transition-all hover:shadow-blue-300'>→</button>
      </div>
